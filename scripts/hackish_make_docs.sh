...
erl -pa _build/generate_documentation/lib/*/ebin -noshell -run edoc_run application "backwater" '[{doclet, edown_doclet}, {top_level_readme, {"README.md", "https://github.com/g-andrade/backwater", "release/1.0.0"}}]'
rm -rf doc
